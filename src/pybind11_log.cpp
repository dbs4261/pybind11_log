//
// Created by Daniel Simon on 6/5/25.
//
...
bool is_enabled(pybind11::object py_logger, int level) {
...
class pybind11_sink : public spdlog::sinks::base_sink<Mutex> {
 public:
  void sink_it_(const spdlog::details::log_msg& msg) override {
    ...
    if (py_logger_.is_none()) {
      auto py_logging = pybind11::module::import("logging");
    ...
    if (is_enabled(py_logger_, level)) {
        auto record = py_logger_.attr("makeRecord")(
            ...
            msg.source.line, msg_payload, pybind11::none(), pybind11::none());
 ...
 private:
  pybind11::object py_logger_ = pybind11::none();
  std::string name_;
};
...
std::shared_ptr<spdlog::logger> pybind11_helper(
